...
class AppointmentRepositoryTest {
	...
	@Container
	static final MariaDBContainer<?> mariadb = new MariaDBContainer<>("mariadb:11.4").withDatabaseName("tt2025_test")
			.withUsername("tt").withPassword("tt");
	...
	void existsOverlap_devuelveTrue_cuandoHaySolapeParcial() {
		var base = fixture();
		crearCita(base.customer, base.vehicle, base.service, LocalDateTime.of(2026, 2, 10, 10, 0),
				LocalDateTime.of(2026, 2, 10, 11, 0), AppointmentStatus.CONFIRMADA);

		boolean solapa = appointmentRepository.existsOverlap(LocalDateTime.of(2026, 2, 10, 10, 30),
				LocalDateTime.of(2026, 2, 10, 11, 30), AppointmentStatus.CANCELADA);
	...
	void existsOverlap_devuelveFalse_cuandoEndEsIgualAStart() {
		...
		boolean solapa = appointmentRepository.existsOverlap(LocalDateTime.of(2026, 2, 10, 11, 0),
				LocalDateTime.of(2026, 2, 10, 12, 0), AppointmentStatus.CANCELADA);
	...
	void existsOverlap_ignoraCanceladas_siSePasaCanceladaComoExclusion() {
		var base = fixture();
		crearCita(base.customer, base.vehicle, base.service, LocalDateTime.of(2026, 2, 10, 10, 0),
				LocalDateTime.of(2026, 2, 10, 11, 0), AppointmentStatus.CANCELADA);
	...
	private void crearCita(CustomerEntity c, VehicleEntity v, ServiceEntity s, LocalDateTime inicio, LocalDateTime fin,
