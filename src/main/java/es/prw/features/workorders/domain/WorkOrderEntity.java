...
public class WorkOrderEntity {
    ...
    @JoinColumn(
        name = "id_appointment",
        nullable = false,
        foreignKey = @ForeignKey(name = "fk_work_orders_appt")
    )
    ...
    @JoinColumn(
        ...
        foreignKey = @ForeignKey(name = "fk_wo_created_by")
    )
    ...
    @JoinColumn(
        ...
        foreignKey = @ForeignKey(name = "fk_wo_updated_by")
    )
    ...
    void onCreate() {
        ...
        if (estado == null) estado = WorkOrderStatus.abierta;
    }
    ...
    public WorkOrderStatus getEstado() { return estado; }
    public void setEstado(WorkOrderStatus estado) { this.estado = estado; }
