...
public interface WorkOrderRepository extends JpaRepository<WorkOrderEntity, Long> {
	...
	@Query("""
			...
			""")
	List<WorkOrderEntity> findListForBackoffice(@Param("status") WorkOrderStatus status, @Param("q") String q);

	// =========================================================
	// MECÁNICO -> solo OTs NO cerradas y asignadas
	// =========================================================
	@Query("""
			    select wo
			    from WorkOrderEntity wo
			    ...
			    order by wo.createdAt desc
			""")
	List<WorkOrderEntity> findOpenAssignedToMechanic(@Param("employeeId") Long employeeId,
			@Param("closed") WorkOrderStatus closed, @Param("q") String q);
}
