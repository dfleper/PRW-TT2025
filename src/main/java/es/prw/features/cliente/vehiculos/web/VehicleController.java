...
public class VehicleController {
	...
	@PostMapping
	public String create(Authentication auth, @Valid @ModelAttribute("vehicle") VehicleDto dto, BindingResult br,
	...
	@PostMapping("/{id}")
	public String update(Authentication auth, @PathVariable Long id, @Valid @ModelAttribute("vehicle") VehicleDto dto,
