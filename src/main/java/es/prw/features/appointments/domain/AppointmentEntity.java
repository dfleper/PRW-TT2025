...
public class AppointmentEntity {
	...
	@JoinColumn(name = "id_customer", nullable = false, foreignKey = @ForeignKey(name = "fk_appointments_customer"))
	private CustomerEntity customer;

	@ManyToOne(fetch = FetchType.LAZY, optional = false)
	@JoinColumn(name = "id_vehicle", nullable = false, foreignKey = @ForeignKey(name = "fk_appointments_vehicle"))
	private VehicleEntity vehicle;

	@ManyToOne(fetch = FetchType.LAZY, optional = false)
	@JoinColumn(name = "id_service", nullable = false, foreignKey = @ForeignKey(name = "fk_appointments_service"))
	private ServiceEntity service;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "id_employee_asignado", foreignKey = @ForeignKey(name = "fk_appointments_employee_asignado"))
	private EmployeeEntity employeeAsignado;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "created_by_user", foreignKey = @ForeignKey(name = "fk_appointments_created_by"))
	private UserEntity createdByUser;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "updated_by_user", foreignKey = @ForeignKey(name = "fk_appointments_updated_by"))
	...
	public EmployeeEntity getEmployeeAsignado() {
		return employeeAsignado;
	}

	public void setEmployeeAsignado(EmployeeEntity employeeAsignado) {
		this.employeeAsignado = employeeAsignado;
	}
