...
public class SecurityConfig {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.authorizeHttpRequests(auth -> auth
        ...
        // ============================================================
        // ✅ TAREA 21 (TEST 500): permitir endpoint /dev/** (SOLO ADMIN)
        // ============================================================
        ...
        // --- OTs: ver listado/detalle (GET) + guardar notas (POST /{id}) -> taller completo ---
        ...
        .requestMatchers(HttpMethod.POST, "/backoffice/citas/*/workorder").hasAnyAuthority(
            "RECEPCION", "ROLE_RECEPCION",
            "JEFE_TALLER", "ROLE_JEFE_TALLER",
            "ADMIN", "ROLE_ADMIN"
        )
